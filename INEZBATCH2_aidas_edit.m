...
% Modified by Burkhard, Karsten & Joeran MPI 2009/01/08
%__________________________________________________________________________
...
%===========================================================================
% user specified path to the SPM5/8 directory
% please check SPM and MATLAB version
%===========================================================================
%path(path,'/afs/cbs/software/matlab/extensions/SPM/5.1782_7.7')
...
n_scans         = [329 143 329 153; 153 354 153 354; 336 158 337 158; 158 336 158 336; 335 159 252 160; 158 339 159 336; 336 166 335 166; 160 336 158 337; 337 166 336 166; 158 336 160 338];              
...
dir_base        = '/Volumes/Aidas_HardDrive/GUITAR_PROJECT_DATA'; % directory which contains all subject-specific directory
dir_analysis    = 'analysis';   % directory where SPM.mat, beta images, con images etc. are stored for each subject
...
%name_subj = {'s10'};
name_subj = {'S10_D1','S10_D2','S11_D1','S11_D2','S12_D1','S12_D2','S13_D1','S13_D2','S14_D1','S14_D2'};
...
while (k<=length(name_subj)),
    ...
    if start_analysis <= 1
      ...
      n_scans = length(V) %Aidas
            ...
            subplot(3,2,sess)
            imagesc(1:n_scans,ys,shuff{sess});
            set(gca,'YDir','Normal')
            hold on
            colormap jet
% n_scans = length(V) % Aidas
