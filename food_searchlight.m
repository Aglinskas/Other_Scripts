...
m_fn = '/Volumes/wonderwoman/WP_2.1.2/Typicality_judgment/GroupAnalysis/mask.nii';
subID = 13;
for sess = 1:2
...
single_scan = cosmo_fmri_dataset(dt_fn,'volumes',TRs(v_ind));
...
measure_args.partitions = cosmo_nfold_partitioner(all_scans.sa.chunks);
nvoxels_per_searchlight=100;
nbrhood=cosmo_spherical_neighborhood(all_scans,'count',nvoxels_per_searchlight);
warning('off','MATLAB:singularMatrix')
lda_results = cosmo_searchlight(all_scans,nbrhood,measure,measure_args);
