...
%%
%sph_radius = 7.5;
masks.all_blobs = load('/Users/aidasaglinskas/Desktop/faces_blobsp01/N40_Blobs_combined.mat');
masks.psts = load('/Users/aidasaglinskas/Desktop/psts_ang_masks/pSTS_mask_roi.mat');
masks.AG = load('/Users/aidasaglinskas/Desktop/psts_ang_masks/AG_mask_roi.mat');
space_fn = '/Users/aidasaglinskas/Google Drive/Aidas:  Summaries & Analyses (WP 1.4)/Data_faces/S7/Analysis/beta_0002.nii';
space = mars_space(space_fn);
