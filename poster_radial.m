...
tmat = tmat - mean(tmat,2);

figure(2);add_numbers_to_mat(tmat2,wh_r_labels,wh_t_labels)
{{'Response to task' 'ttest against 0'} {'Congtive preference' 'task vs mean of other tasks'}}
...
use_mat = mats{2}; % hac
wh_plot_list_red = wh_plot_list(5:end);
wh_plot = wh_plot_list_red{sp_ind}
wh_plot = 1:5
for i = wh_plot
%r_ind = randi(10)
r_ind = (i);
