...
close all
loadMR
analysis_name = 'cor_model_network';
...
% separate PNGs
arrayfun(@(x) export_fig(['/Users/aidasaglinskas/Desktop/2nd_Fig/' analysis_name tm '_' num2str(x.Number) '.png'],x),figs,'UniformOutput',0)
% single PS
